...
- __Important change:__ the Boolean option `show_plot` has been removed from all `inspect_*()` functions.  To generate visualisations of data frame summaries, please use `show_plot(inspect_*())` or using the pipe  `inspect_*() %>% show_plot()`.
