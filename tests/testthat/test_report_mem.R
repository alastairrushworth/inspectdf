...
test_that("Plot single output works", {
  set.seed(10)
  expect_is(report_mem(mtcars, show_plot = T), "data.frame")
  expect_is(report_mem(band_instruments, show_plot = T) , "data.frame")
  expect_is(report_mem(starwars, show_plot = T), "data.frame")
  expect_is(report_mem(storms, show_plot = T), "data.frame")
  expect_is(report_mem(airquality, show_plot = T), "data.frame")
})