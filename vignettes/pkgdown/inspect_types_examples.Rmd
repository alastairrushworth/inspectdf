...
To illustrate the comparison of two data frames, we create two new data frames by randomly sampling the rows of `starwars` and also dropping some of the columns, and .  The results are assigned to the objects `star_1` and `star_2`:
